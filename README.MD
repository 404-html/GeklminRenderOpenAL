...
1) it's pretty fast- Here's some benchmark figures on a GTX 960 SSC at 1080p
CONDITIONS:
...
Number of 5000 poly meshes able to be rendered at around 60 fps when spawned randomly via 'E' in the demo:
